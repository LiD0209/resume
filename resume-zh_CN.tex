...
\noindent 在美团地图团队担任后端开发工程师，参与地图基础能力及相关业务服务建设，负责从需求评审、方案设计、接口开发到联调上线的完整迭代流程。围绕地图数据查询与服务接口，梳理上下游依赖、调用链路及异常场景，完成数据处理逻辑和服务能力交付，支撑业务方稳定接入地图能力；针对线上慢调用、异常请求和数据一致性问题开展定位与治理，推进问题复现、根因分析、修复验证和复盘闭环，保障服务稳定运行。协同产品、客户端、测试及上下游团队推进需求验收和版本发布，并沉淀接口文档与技术方案，提升后续维护与协作效率。
